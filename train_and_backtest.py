...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, required=True, choices=["dqn", "ddpg", "ppo", "a2c"], help="Model type.")
    ...
    # parser.add_argument("--continuous", action="store_true", help="Use discrete action space.")
